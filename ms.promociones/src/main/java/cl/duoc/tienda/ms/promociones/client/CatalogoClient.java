package cl.duoc.tienda.ms.promociones.client;

import cl.duoc.tienda.ms.promociones.dto.JuegoExternoDTO;
import cl.duoc.tienda.ms.promociones.exception.RecursoNoEncontradoException;
import cl.duoc.tienda.ms.promociones.exception.ServicioExternoException;
...
public class CatalogoClient {
    ...
    @Value("${servicios.catalogo.juegos.url}")
    private String urlBase;

    public JuegoExternoDTO obtenerJuego(Long id) {
        log.debug("Consultando juego {} en MS-Catalogo", id);
        try {
            ...
            throw new ServicioExternoException("Error consultando MS-Catalogo");
        } catch (Exception e) {
