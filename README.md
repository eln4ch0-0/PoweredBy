[README.md](https://github.com/user-attachments/files/28039277/README.md)
...
flowchart TB
    ...
    Client -->|POST /compras| Compras
    Compras -->|GET usuario<br/>PUT descontar-saldo| Usuarios
    Compras -->|GET juego| Catalogo
    Usuarios --- DBu
    Catalogo --- DBc
    Compras --- DBp
```
